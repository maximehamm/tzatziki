...
public class TzJavaStepDefinitionCreator extends AbstractStepDefinitionCreator {
    ...
    private final static Logger LOG = Logger.getInstance(TzJavaStepDefinitionCreator.class);
